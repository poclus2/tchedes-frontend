        ...
        <div className="max-w-6xl w-full bg-white rounded-3xl shadow-card overflow-hidden flex min-h-[700px]">
            ...
            <div className="w-full lg:w-1/2 p-8 lg:p-12 xl:p-16 flex flex-col justify-center">
                <div className="mb-10">
                    ...
                    <h1 className="text-3xl font-bold font-display text-slate-900 mb-2">Reset your password</h1>
                    <p className="text-slate-500 text-lg">Enter your email address to receive password reset instructions.</p>
                </div>
                <form className="space-y-6">
                    <div>
                        <label className="block text-sm font-semibold text-slate-700 mb-1.5" htmlFor="work-email">Work email</label>
                        <input className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-800 placeholder-slate-400 outline-none" id="work-email" placeholder="name@company.com" type="email" />
                    </div>

                    <button className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary/30 transition-all transform active:scale-[0.98] mt-4" type="button">
                        Send reset link
                    </button>

                    <Link href="/login" className="w-full border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2">
